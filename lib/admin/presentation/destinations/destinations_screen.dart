            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  const Text('Rules and regulations'),
                  const SizedBox(height: 10),
                  CustomTextfield(
                    maxLine: 7,
                    textEditingController: _rulesController,
                    focusNode: _rulesFocusNode,
                    hintText: tr('Rules and regulations...'),
                    onEditingComplete: () {
                      FocusScope.of(context).requestFocus(_bagPackingFocusNode);
                    },
                    validator: (value) {
                      if (value!.isEmpty) {
