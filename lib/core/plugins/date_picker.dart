...
import 'package:trek_high/core/plugins/custom_date_picker.dart';
  ...
  Widget build(BuildContext context) {
    ...
    CustomCalendarDatePicker calendarDatePicker() {
      return CustomCalendarDatePicker(
        onDateSelect: widget.onSelectDate,
    ...
    return Dialog(
      ...
      insetPadding: const EdgeInsets.symmetric(vertical: 1),
...
class _CalendarDateRangePickerState extends State<_CalendarDateRangePicker> {
  ...
  Widget _buildMonthItem(
    ...
    final month = DateUtils.addMonthsToMonthDate(widget.firstDate, monthIndex);
    return _MonthItem(
...
class _InputDateRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final onPrimarySurfaceColor = colorScheme.brightness == Brightness.light
        ? colorScheme.onPrimary
        : colorScheme.onSurface;
    final dateStyle = orientation == Orientation.landscape
